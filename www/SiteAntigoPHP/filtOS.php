...
mysql_select_db($database_cn1, $cn1);
$query_rsnumos = "SELECT os.str_OsNum, os.str_OsNum FROM os";
$rsnumos = mysql_query($query_rsnumos, $cn1) or die(mysql_error());
$row_rsnumos = mysql_fetch_assoc($rsnumos);
$totalRows_rsnumos = mysql_num_rows($rsnumos);
...
<table width="100%" height="470" border="0" cellpadding="0" cellspacing="0">
 ...
 <tr>
	...
	<table width="100%" border="0">
      <tr>
        <th class="SEL" scope="col"><div align="center">DIGITE O NÚMERO DA OS </div></th>
      </tr>
      <tr>
        <th class="SEL" scope="col"><form id="form1" name="form1" method="post" action="filtOS2.php">
          <label for="txtnumos"></label>
          <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_rsnumos['str_OsNum']; ?>" />
          <input type="text" name="txtnumos" id="txtnumos" />
          <input type="submit" name="btnnumos" id="btnnumos" value="PROCURA OS" />
        </form></th>
      </tr>
    </table>
	<div align="center">
